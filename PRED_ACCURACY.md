...
_更新:2026-06-18 11:08:31　已評估場次:24_

## 總指標

- 1X2 命中率:**50%**（12/24）
- RPS：**0.187**（越低越好;隨機基準 0.215）
- Brier：0.646　Log-loss：1.068
- 精確比分命中率：4%　進球差 MAE：1.71　總進球 MAE：1.46
- 本屆和局率：**38%**（9/24） vs 歷史 22%（遠高於歷史，留意是否為變異）

> RPS 0.187 vs 隨機 0.215 → **優於隨機**。
...
- **#31 Netherlands vs Japan**：❌ 模型看好Netherlands贏，最後雙方言和；模型其實也給了和局 26%；合理變異:三方接近(主43/和26/客30),模型信心本就低；兩隊實力接近(Elo 僅差 20)。
