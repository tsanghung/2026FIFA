...
_更新:2026-06-17 06:08:44　已評估場次:19_
...
- 1X2 命中率:**47%**（9/19）
- RPS：**0.184**（越低越好;隨機基準 0.208）
- Brier：0.666　Log-loss：1.095
- 精確比分命中率：5%　進球差 MAE：1.79　總進球 MAE：1.47
- 本屆和局率：**42%**（8/19） vs 歷史 22%（遠高於歷史，留意是否為變異）

> RPS 0.184 vs 隨機 0.208 → **優於隨機**。
