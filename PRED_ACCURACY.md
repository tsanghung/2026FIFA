...
_更新:2026-06-28 10:27:36　已評估場次:72_

## 總指標

- 1X2 命中率:**62%**（45/72）
- RPS：**0.148**（越低越好;隨機基準 0.231）
- Brier：0.493　Log-loss：0.856
- 精確比分命中率：8%　進球差 MAE：1.62　總進球 MAE：1.60
...
- **#65 Colombia vs Portugal**：❌ 模型看好Portugal贏，最後雙方言和；模型其實也給了和局 29%；合理變異:三方接近(主33/和29/客37),模型信心本就低；兩隊實力接近(Elo 僅差 36)。
