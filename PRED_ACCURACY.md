...
_更新:2026-06-14 05:48:09　已評估場次:7_
...
- 1X2 命中率:**57%**（4/7）
- RPS：**0.168**（越低越好;隨機基準 0.206）
- Brier：0.642　Log-loss：1.062
- 精確比分命中率：14%　進球差 MAE：1.57　總進球 MAE：1.00

> RPS 0.168 vs 隨機 0.206 → **優於隨機**。
...
| 13 | Brazil vs Morocco | 43/26/31 | 2-1 | 1-1 | ❌ | — |
...
- **#13 Brazil vs Morocco**：❌ 模型看好Brazil贏，最後雙方言和；模型其實也給了和局 26%；合理變異:三方接近(主43/和26/客31),模型信心本就低；兩隊實力接近(Elo 僅差 4)。
