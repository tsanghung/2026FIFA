...
_更新:2026-06-17 17:49:37　已評估場次:20_

## 總指標

- 1X2 命中率:**50%**（10/20）
- RPS：**0.179**（越低越好;隨機基準 0.211）
- Brier：0.644　Log-loss：1.065
- 精確比分命中率：5%　進球差 MAE：1.70　總進球 MAE：1.50
- 本屆和局率：**40%**（8/20） vs 歷史 22%（遠高於歷史，留意是否為變異）

> RPS 0.179 vs 隨機 0.211 → **優於隨機**。
