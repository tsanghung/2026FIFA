...
_更新:2026-06-26 21:18:27　已評估場次:62_

## 總指標

- 1X2 命中率:**63%**（39/62）
- RPS：**0.157**（越低越好;隨機基準 0.235）
- Brier：0.508　Log-loss：0.877
- 精確比分命中率：10%　進球差 MAE：1.68　總進球 MAE：1.58
- 本屆和局率：**26%**（16/62） vs 歷史 22%

> RPS 0.157 vs 隨機 0.235 → **優於隨機**。
