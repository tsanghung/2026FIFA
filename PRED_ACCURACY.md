...
_更新:2026-06-15 11:41:56　已評估場次:12_
...
- 1X2 命中率:**50%**（6/12）
- RPS：**0.196**（越低越好;隨機基準 0.222）
- Brier：0.635　Log-loss：1.057
- 精確比分命中率：8%　進球差 MAE：1.67　總進球 MAE：1.33

> RPS 0.196 vs 隨機 0.222 → **優於隨機**。
...
| 13 | Brazil vs Morocco | 42/26/32 | 2-1 | 1-1 | ❌ | — |
...
| 26 | Ivory Coast vs Ecuador | 25/25/50 | 1-2 | 1-0 | ❌ | — |
| 31 | Netherlands vs Japan | 45/26/29 | 2-1 | 2-2 | ❌ | — |
...
- **#13 Brazil vs Morocco**：❌ 模型看好Brazil贏，最後雙方言和；模型其實也給了和局 26%；合理變異:三方接近(主42/和26/客31),模型信心本就低；兩隊實力接近(Elo 僅差 4)。
...
- **#31 Netherlands vs Japan**：❌ 模型看好Netherlands贏，最後雙方言和；模型其實也給了和局 26%；合理變異:三方接近(主45/和26/客29),模型信心本就低；兩隊實力接近(Elo 僅差 20)。
