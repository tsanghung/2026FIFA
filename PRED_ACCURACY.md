...
_更新:2026-06-19 14:15:02　已評估場次:28_

## 總指標

- 1X2 命中率:**54%**（15/28）
- RPS：**0.178**（越低越好;隨機基準 0.218）
- Brier：0.615　Log-loss：1.023
- 精確比分命中率：4%　進球差 MAE：1.68　總進球 MAE：1.54
- 本屆和局率：**36%**（10/28） vs 歷史 22%（遠高於歷史，留意是否為變異）

> RPS 0.178 vs 隨機 0.218 → **優於隨機**。
...
| 3 | Czechia vs South Africa | 55/25/20 | 2-0 | 1-1 | ❌ | — |
| 4 | Mexico vs South Korea | 46/29/25 | 2-1 | 1-0 | ✅ | — |
...
| 10 | Canada vs Qatar | 64/20/16 | 2-0 | 6-0 | ✅ | — |
| 13 | Brazil vs Morocco | 41/27/32 | 2-1 | 1-1 | ❌ | — |
...
| 50 | Iraq vs Norway | 16/19/64 | 0-2 | 1-4 | ✅ | — |
| 55 | Argentina vs Algeria | 62/21/17 | 2-0 | 3-0 | ✅ | — |
| 56 | Austria vs Jordan | 61/22/18 | 2-0 | 3-1 | ✅ | — |
| 61 | Portugal vs DR Congo | 65/19/16 | 2-0 | 1-1 | ❌ | — |
| 62 | Uzbekistan vs Colombia | 16/18/66 | 0-3 | 1-3 | ✅ | — |
| 67 | England vs Croatia | 50/25/25 | 2-1 | 4-2 | ✅ | — |
| 68 | Ghana vs Panama | 20/25/54 | 0-2 | 1-0 | ❌ | — |

## 逐場差異與原因

- **#1 Mexico vs South Africa**：✅ 命中:模型賽前看好主勝（Mexico 69%，高信心），結果如預期。
- **#2 South Korea vs Czechia**：✅ 命中:模型賽前看好主勝（South Korea 39%，低信心），結果如預期。
- **#3 Czechia vs South Africa**：❌ 模型看好Czechia贏，最後雙方言和；模型其實也給了和局 25%。
- **#4 Mexico vs South Korea**：✅ 命中:模型賽前看好主勝（Mexico 46%，中信心），結果如預期。
...
- **#10 Canada vs Qatar**：✅ 命中:模型賽前看好主勝（Canada 64%，高信心），結果如預期。
- **#13 Brazil vs Morocco**：❌ 模型看好Brazil贏，最後雙方言和；模型其實也給了和局 27%；合理變異:三方接近(主41/和27/客32),模型信心本就低；兩隊實力接近(Elo 僅差 4)。
...
- **#31 Netherlands vs Japan**：❌ 模型看好Netherlands贏，最後雙方言和；模型其實也給了和局 27%；合理變異:三方接近(主43/和27/客30),模型信心本就低；兩隊實力接近(Elo 僅差 20)。
...
- **#50 Iraq vs Norway**：✅ 命中:模型賽前看好客勝（Norway 64%，高信心），結果如預期。
- **#55 Argentina vs Algeria**：✅ 命中:模型賽前看好主勝（Argentina 62%，高信心），結果如預期。
- **#56 Austria vs Jordan**：✅ 命中:模型賽前看好主勝（Austria 61%，高信心），結果如預期。
- **#61 Portugal vs DR Congo**：❌ 模型看好Portugal贏，最後雙方言和；模型其實也給了和局 19%；大冷門:模型高度看好仍翻盤,多為紅牌/定位球/門將神勇等臨場因素。
- **#62 Uzbekistan vs Colombia**：✅ 命中:模型賽前看好客勝（Colombia 66%，高信心），結果如預期。
- **#67 England vs Croatia**：✅ 命中:模型賽前看好主勝（England 50%，中信心），結果如預期。
- **#68 Ghana vs Panama**：❌ 模型看好Panama（54%），最後由Ghana勝出。
