...
_更新:2026-06-30 08:00:24　已評估場次:76_

## 總指標

- 1X2 命中率:**62%**（47/76）
- RPS：**0.149**（越低越好;隨機基準 0.230）
- Brier：0.499　Log-loss：0.864
- 精確比分命中率：9%　進球差 MAE：1.59　總進球 MAE：1.54
...
| 13 | Brazil vs Morocco | 37/29/33 | 2-1 | 1-1 | ❌ | — |
...
| 74 | Brazil vs Japan | 49/27/24 | 2-1 | 2-1 | ✅ | ✅ |
| 75 | Germany vs Paraguay | 60/23/17 | 2-0 | 1-1 | ❌ | — |
| 76 | Netherlands vs Morocco | 37/28/34 | 2-1 | 1-1 | ❌ | — |
...
- **#13 Brazil vs Morocco**：❌ 模型看好Brazil贏，最後雙方言和；模型其實也給了和局 29%；合理變異:三方接近(主37/和29/客33),模型信心本就低；兩隊實力接近(Elo 僅差 24)。
...
- **#24 Paraguay vs Australia**：❌ 模型看好Australia贏，最後雙方言和；模型其實也給了和局 30%；兩隊實力接近(Elo 僅差 24)。
...
- **#74 Brazil vs Japan**：✅ 命中:模型賽前看好主勝（Brazil 49%，中信心），結果如預期。
- **#75 Germany vs Paraguay**：❌ 模型看好Germany贏，最後雙方言和；模型其實也給了和局 23%。
